...
data, or unresolved source. Prefer conditional expected-OID ref deletion. If a
remote host cannot condition deletion, retain its ref. Filesystem deletion is
one exact canonical path after the final check; never use wildcards or broad
recursive deletion.
