---
title: "Tailrocks: tailrocks-document — Skill definition"
description: "Verbatim definition of tailrocks-document."
---

Source: [SKILL.md](https://github.com/tailrocks/tailrocks-pull-request-skills/blob/main/skills/tailrocks-document/SKILL.md)
