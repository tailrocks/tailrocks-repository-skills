---
title: "Tailrocks: tailrocks-create-pr — Skill definition"
description: "Verbatim definition of tailrocks-create-pr."
---

Source: [SKILL.md](https://github.com/tailrocks/tailrocks-pull-request-skills/blob/main/skills/tailrocks-create-pr/SKILL.md)
...
[`references/repo-conventions.md`](https://github.com/tailrocks/tailrocks-pull-request-skills/blob/main/skills/tailrocks-create-pr/references/repo-conventions.md) — read it
...
4. **Build the body.** Read
   [`references/pr-body.md`](https://github.com/tailrocks/tailrocks-pull-request-skills/blob/main/skills/tailrocks-create-pr/references/pr-body.md). If the conventions file
