---
title: "Tailrocks: tailrocks-review-pr — Skill definition"
description: "Verbatim definition of tailrocks-review-pr."
---

Source: [SKILL.md](https://github.com/tailrocks/tailrocks-pull-request-skills/blob/main/skills/tailrocks-review-pr/SKILL.md)
...
4. **Hunt correctness findings.** Read
   [`finding-bar.md`](https://github.com/tailrocks/tailrocks-pull-request-skills/blob/main/skills/tailrocks-review-pr/references/finding-bar.md). Sweep twice with
...
6. **Run the structural pass.** Read
   [`structural-review.md`](https://github.com/tailrocks/tailrocks-pull-request-skills/blob/main/skills/tailrocks-review-pr/references/structural-review.md). Look for the
...
7. **Run the triggered specialist lanes.** Read
   [`specialist-lanes.md`](https://github.com/tailrocks/tailrocks-pull-request-skills/blob/main/skills/tailrocks-review-pr/references/specialist-lanes.md). Tests changed
...
9. **Report only.** Read [`reporting.md`](https://github.com/tailrocks/tailrocks-pull-request-skills/blob/main/skills/tailrocks-review-pr/references/reporting.md) for the
...
- the verdict against the approval bar in
  [`reporting.md`](https://github.com/tailrocks/tailrocks-pull-request-skills/blob/main/skills/tailrocks-review-pr/references/reporting.md);
