---
title: "Tailrocks: tailrocks-merge-pr — Skill definition"
description: "Verbatim definition of tailrocks-merge-pr."
---

Source: [SKILL.md](https://github.com/tailrocks/tailrocks-pull-request-skills/blob/main/skills/tailrocks-merge-pr/SKILL.md)
...
3. **Run the machine preflight.** Resolve the real path of this installed
   ...
   Read [`references/delivery-artifacts-policy.md`](https://github.com/tailrocks/tailrocks-pull-request-skills/blob/main/skills/tailrocks-merge-pr/references/delivery-artifacts-policy.md),
