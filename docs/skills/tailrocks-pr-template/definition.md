---
title: "Tailrocks: tailrocks-pr-template — Skill definition"
description: "Verbatim definition of tailrocks-pr-template."
---

Source: [SKILL.md](https://github.com/tailrocks/tailrocks-pull-request-skills/blob/main/skills/tailrocks-pr-template/SKILL.md)
...
[`references/PULL_REQUEST_TEMPLATE.md`](https://github.com/tailrocks/tailrocks-pull-request-skills/blob/main/skills/tailrocks-pr-template/references/PULL_REQUEST_TEMPLATE.md);
